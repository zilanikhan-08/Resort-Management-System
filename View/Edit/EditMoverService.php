...
if(!isset($_COOKIE['flag'])){
    ...
    $con = dbConnection();
    $query = "SELECT * FROM `moverservice`"; 
...
<td>
    ...
    <tr>
        ...
        while($info = mysqli_fetch_assoc($data))
        {
            ...
            <td><a href='Edit_Movers_Form.php?id=$info[S_ID]'>Edit</a></td>
            <td><a href='../../controller/Delete/Delete_Movers.php?id=$info[S_ID]'>Delete</a></td>
            </tr>";
        }
